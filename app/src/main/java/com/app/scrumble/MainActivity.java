...
public class MainActivity extends AppCompatActivity {
    ...
    public Comment getCommentByResourceID(int resourceID){
        for(Comment comment : exampleComments){
            if(comment.getResourceID() == resourceID){
                return comment;
            }
        }
        return null;
    ...
    protected List<Scrapbook> getScrapbooks(){
        return this.scrapbooks;
    }

    protected List<User> getUsers(){
        if(currentUser != null){
            List<User> combinedUsers = new ArrayList<>(users);
            combinedUsers.add(currentUser);
    ...
    protected User getUsersByUsername(String username){
